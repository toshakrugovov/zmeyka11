...
namespace ZmeykaGame
{
    ...
    internal class Program
    {
        ...
        private static void Logic()
        {
            ...
            if (_direction == Direction.Up) { _head.Y--; }
            else if (_direction == Direction.Down) { _head.Y++; }
            else if (_direction == Direction.Left) { _head.X--; }
            else if (_direction == Direction.Right) { _head.X++; }

            // Check if the snake hits the boundary of the game area
            if (_head.X == 0 || _head.X == _size.Width - 1 || _head.Y == 0 || _head.Y == _size.Height - 1)
            {
                _gameOver = true;
                _direction = Direction.Stop;
            }
